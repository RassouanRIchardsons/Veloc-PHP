                                    ...
                                    <article class="card-body mx-auto" style="max-width: 400px;">
                                        ...
                                        <form method="POST" action="admin/recueil.php">
                                            ...
                                            <div class="form-group input-group">
                                                ...
                                                <input name="password_utilisateur" class="form-control" placeholder="Répeter votre mot de passe" type="password">
                                            </div>
                                            <!-- SUBMIT -->
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary btn-block">Créer son compte</button>
                                            </div>       
